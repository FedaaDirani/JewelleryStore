...
import 'package:jewelrey_store/shared/chat_bubble.dart';
import 'package:jewelrey_store/shared/recived_messages.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          [
            ...
            Padding(
              padding: const EdgeInsets.only(top: 400, left: 39,),
              child: Container(
                width: 124,
                height: 32,
                decoration: ShapeDecoration(
                ...
                child: MaterialButton(
                  ...
                  {
                    Navigator.push(context, MaterialPageRoute(
                      builder: (context) => NoReturnScreen(
                      ),
                    ),
                    );
                  },
